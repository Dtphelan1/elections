    ...
    return (
        <PageSection className="text-left">
            ...
            <div className="row d-flex mb-3">
                <div className="col-sm-12 col-md-6">
                    <p>
                        ...
                        In November, our country will deicide who will us for the next 1460 days.
            ...
            <p>
                ...
                By the end of this exploration, hopefully readers have learned about different voting systems work, how we want them to work, the chasm between those two ideas, and how we can start to bridge that chasm.
            </p>
        </PageSection>
    );
}
